...
import { seguirTriagem, seguirCliente, seguirAgenda } from '../../actions/actions';
    ...
    const colunas = [
        {
            ...
            formatter: (cell, row) => {
                return <Button className='iconeExpandiButton' onClick={(e) => { localStorage.setItem('idPacliente', row.id_pacliente); 
                   localStorage.setItem('nomePacliente', row.nome);
                    despacho(seguirAgenda(false)); window.location.href = '/agendar/consulta/especialidade'
                 }}>
