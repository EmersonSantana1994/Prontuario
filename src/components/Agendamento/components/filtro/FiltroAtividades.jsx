...
FiltroAtividades.propTypes = {
    atividades: PropTypes.any.isRequired, // ou o tipo adequado, dependendo do que 'atividades' deve ser
    onSelecionarAtividades: PropTypes.any.isRequired,
  };
